...
api_id = int(os.environ.get("12488427"))
api_hash = os.environ.get("cef695e1719a0f7833574f44c7715482")
token = os.environ.get("5659214505:AAH5LIZhpPxu1n9s0RXAEvoDhSBywth3xCE")
...
async def start(client, message):
   await message.reply_text(
      ...
      reply_markup=InlineKeyboardMarkup(
         [
            [
               InlineKeyboardButton("❕ ┇ كيفيه استخدام البوت", url=f"https://t.me/dev_dzz/41"),
               InlineKeyboardButton("", url=f"https://t.me/dev_dzz"),
            ]
         ]
      )
   )
